	...
	class PStroj
	{
		...
		static void Main(string[] args)
		{
			...
			try
			{
				...
				{
					Console.WriteLine("Greska pri izvrsavanju p-programa.");
					Console.WriteLine("Opis greske: {0}", exc.Message);
				}
			}
			catch (Exception exc)
			{
				Console.WriteLine("Greska pri ucitavanju p-programa.");
				Console.WriteLine("Opis greske: {0}", exc.Message);
			}
		...
		static void Ucitaj(String ulaz)
		{
			String Line;
			String[] element;
		...
		static ArrayList kodovi=new ArrayList();
		static ArrayList labele1=new ArrayList();
		static ArrayList labele2=new ArrayList();
		static ArrayList p_labele=new ArrayList();
		static ArrayList p_labele1=new ArrayList();
		static ArrayList p_labele2=new ArrayList();
		static byte[] stog;

		static bool _dijagnostika = false;
		static bool _dijagnostika2 = false;
		static int _velicinaStoga = 10000;
	}
}
